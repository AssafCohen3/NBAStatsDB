...
from Database.Models.BREFPlayer import BREFPlayer
from Database.Models.BoxScoreT import BoxScoreT
from Database.Models.PlayerMapping import PlayerMapping
from Resources.AwardsResourceHandler import AwardsResourceHandler
from Resources.BREFPlayerResourceHandler import BREFPlayerResourceHandler
from Resources.EventResourceHandler import EventResourceHandler
from Resources.OddsResourceHandler import OddsResourceHandler
from Resources.PlayerBoxScoreResourceHandler import PlayerBoxScoreResourceHandler
from Resources.PlayerMappingResourceHandler import PlayerMappingResourceHandler
from Resources.PlayerResourceHandler import PlayerResourceHandler
from Resources.PlayoffSerieSummaryResourceHandler import PlayoffSerieSummaryResourceHandler
from Resources.TeamBoxScoreResourceHandler import TeamBoxScoreResourceHandler
from Resources.TransactionsResourceHandler import TransactionsResourceHandler
...
class NbaStatsDB:
    def __init__(self):
        ...
        self.engine = create_engine('sqlite:///' + DATABASE_PATH + DATABASE_NAME_NEW + '.sqlite')
    ...
    def run(self, args):
        if args.debug_requests:
            ...
            logging.getLogger('urllib3.connectionpool').addHandler(RequestsLogger.MyLoggingHandler())
