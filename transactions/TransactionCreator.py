...
class TransactionCreator:
    def __init__(self):
        ...
        self.transformations_chain = {
            ...
            'sold_rights': [self.create_move_transaction('sold rights', False, 'sold rughts'), self.optional_property('additional', self.get_single_and_assert)],
            ...
            'recalling': [self.create_sign_transaction('recall', False, 'leave team'), self.collect_to_unknown(['recalling_from_team', 'where'])],
            'claimed_from_waivers': [self.create_move_transaction('claim from waivers', False, 'claim from waivers')],
